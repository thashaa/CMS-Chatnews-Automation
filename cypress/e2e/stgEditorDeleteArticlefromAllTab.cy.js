describe('CMS Staging: Delete Article from All Tab', () => {
  beforeEach(() => {
    cy.clearCookies();
  ...
  it('Delete Article from All Tab', () => {
    cy.EditorAllPost()
    //go to All tab 
   ...
   //select article and click trash 
     .get('#all > .rounded-xl > .align-middle > .min-w-full > .text-sm > :nth-child(1) > :nth-child(10)')
